...
export function ReimburseForm({
  ...
  return (
    <Stack gap="sm">
      ...
      <Text fz="xs" c="dimmed">
        Компенсация — не расход: трата была подготовлена сбережениями прошлых месяцев. Запись спишет
        сумму со статьи фонда{settle === 'from_account' ? ' и со счёта КС' : ', а следующее пополнение станет меньше'}.
      </Text>
    </Stack>
  );
}
